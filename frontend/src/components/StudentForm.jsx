...
const StudentForm = ({ student = null, onSuccess }) => {
  ...
  const checkStudentId = (id) => {
    if (!id) return;
    fetch(`http://localhost/student-project/checkStudentId.php?student_id=${id}`)
      .then(res => res.text())
      .then(text => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = student
      ? 'http://localhost/student-project/updateStudent.php'
      : 'http://localhost/student-project/saveStudent.php';
